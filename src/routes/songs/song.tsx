				...
				<div className="w-full md:w-1/2">
					...
					{!isEditing ? (
						<>
							...
							<select value={format} name="format" defaultValue="digital" onChange={handleFormatSelect} className="select max-w-30">
						...
						<form className="flex flex-col gap-2">
							<div>
								<label className="block text-sm font-medium text-black-300 mb-1">Titulo: </label>
								<input type="text" name="title" value={editableSong.title}
							...
							<div>
								<label className="block text-sm font-medium text-black-300 mb-1">Autor: </label>
								<input type="text" name="artist" value={editableSong.artist}
															onChange={handleInputChange}
															className="w-full bg-white border border-gray-700 text-black rounded-md p-2 focus:ring-blue-500 focus:border-blue-500"/>
							</div>
							...
							<div>
								...
								<input type="text" name="digitalPrice" value={editableSong.digitalPrice}
															onChange={handleInputChange}
															className="w-full bg-white border border-gray-700 text-black rounded-md p-2 focus:ring-blue-500 focus:border-blue-500"/>

								<label className="block text-sm font-medium text-black-300 mb-1">Descripción: </label>
								<input type="text" name="description" value={editableSong.description}
															onChange={handleInputChange}
															className="w-full bg-white border border-gray-700 text-black rounded-md p-2 focus:ring-blue-500 focus:border-blue-500"/>
							</div>

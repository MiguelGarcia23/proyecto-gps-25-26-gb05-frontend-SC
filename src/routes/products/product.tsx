...
const minimo = (precio1:number, precio2:number, precio3:number, precio4: number) => {
		...
		<div className="card bg-base-100 w-96 shadow-sm pt-4">
			...
			<div className="card-body">
				...
				<div className="flex justify-between w-full">
					<p className="flex justify-end">Desde: {minimo(item.item.item.pricing.cd,item.item.item.pricing.digital,item.item.item.pricing.cassette,item.item.item.pricing.vinyl)}€</p>
				</div>

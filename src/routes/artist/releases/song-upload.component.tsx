						...
						<div className="flex flex-col gap-2">
							<div className="relative inline-block">
								...
								<button
									...
									onClick={() => document.getElementById('upload-song-cover-input')?.click()}
								>
							...
							<button
								...
								onClick={() => document.getElementById('upload-song-file-input')?.click()}
							>
									...
									<div className="flex flex-wrap gap-2">
										{
											availableGenres.map(g =>
													<span
														className={`badge badge-${selectedGenres.some(
															i => i.uuid === g.uuid
														) ? 'primary' : 'ghost'}`}
														onClick={() => {
															if (selectedGenres.some(i => i.uuid === g.uuid)) {
																setSelectedGenres(selectedGenres.filter(i => i.uuid !== g.uuid));
															} else {

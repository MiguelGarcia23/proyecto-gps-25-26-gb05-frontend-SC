	...
	return (
		<div className="card w-full max-w-xl bg-white p-6 shadow text-center">
			...
			<form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
					...
					<input type="text" placeholder="John" className="input w-full" {...register("firstName", { required: true })} />

					<label className="label">Apellidos</label>
					<input type="text" placeholder="Doe" className="input w-full" {...register("lastName", { required: true })} />
